...
export default function Header() {
  ...
  return (
      <header
        className={` z-50 sticky lg:pt-0 lg:w-full top-0 ${
        ...
        <nav className=" container w-11/12 mx-auto">
          <div className="flex items-center justify-between">
            <div className=" flex items-center w-7/12 justify-between">
              ...
              <div className=" hidden lg:flex gap-14 items-center">
                ...
                <button
                  ...
                  className={`font-bold hover:bg-dark-color hover:bg-opacity-20 hover:text-opacity-100 focus:ring-0 focus:outline-none rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center ${
                    showBackground ? " text-white hover:bg-slate-500" : ""
                  } `}
                  type="button"
                >
                  Tentang Kami{" "}
            ...
            <div>
              <Button
                name="Daftar"
                className={` hidden lg:block py-3 px-12 bg-gradient-to-br ${
